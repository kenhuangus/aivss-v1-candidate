...
from .ai_metrics import AIProfile, split_ai_vector
...
def assess(a: Assessment) -> dict[str, Any]:
    ...
    mode2 = lookup_aivss(cvss_only, metrics, ai_class)
    ...
    report: dict[str, Any] = {
        ...
        "scores": {
            "mode1_interpretation": {
                "aivss": cvss_bte,
                "basis": "AIVSS = CVSS-BTE; AI metrics reported as profile only",
                "status": "normative",
            },
            "mode2_macrovector": {
                "aivss_btea": mode2["aivss_btea"],
                "promoted_macrovector": mode2["promoted_macrovector"],
                "delta": mode2["delta"],
                "saturated": mode2["saturated"],

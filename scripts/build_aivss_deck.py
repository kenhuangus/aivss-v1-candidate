...
SLIDES_DATA = [
    ...
    },
    {
        ...
        "lang_tag": "BASH",
        "highlight_lines": [2, 5, 11, 15],
        "code_lines": [
            '# 1. Install the verified AIVSS 1.0 calculator package',
            'pip install -e ".[dev]"',
            '',
            '# 2. Run the automated test suite (177 test cases passing)',
            ...
            '',
            '# 4. Score a CVSS v4.0 vector with its AIVSS 1.0 extension vector',
            'aivss-calc profile "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:N/SC:H/SI:L/SA:N/E:P" \\',
            '  --aivss-vector "AIVSS:1.0/LC:I/CP:C/AP:N/SR:P/EX:W/PT:L/CA:N/TD:H"',
            '',
            '# 5. Evaluate the SSVC / BOD 26-04 deployer decision table',
            'aivss-calc decide --cve-id CVE-2025-32711 --publicly-exposed true \\',
            '  --publicly-exposed-source "internet-facing web portal" \\',
            '  --decision-data-observed-at 2026-08-27T00:00:00Z --kev false \\',
            '  --automatable true --technical-impact total --epss 0.42 \\',
            '  --epss-date 2026-08-27',
            '',
        ...
        <div id="slide-content-wrap" class="slide-1-container idea-slide">
          ...
          <div class="slide-1-pillars-row">
            ...
            <div class="slide-1-pillar-pill">
              ...
              <div class="slide-1-pillar-desc">Open-source Python SDK &amp; CLI with 177 verified pytest tests.</div>
            </div>
          </div>
        </div>`;
    }
